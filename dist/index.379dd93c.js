...
var _comicsJs = require("./components/Comics/Comics.js");
var _comicsJsDefault = parcelHelpers.interopDefault(_comicsJs);
(async ()=>{
    await _appDefault.default.render();
    _comicsJsDefault.default.eventListener();
})();

},{"regenerator-runtime/runtime":"1EBPE","./components/App/App":"7dJa6","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./components/Comics/Comics.js":"8mKgD"}],"1EBPE":[function(require,module,exports) {
/**
...
},{}],"7dJa6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../Comics/Comics":"8mKgD","./App.css":"2urye","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8mKgD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _charactersJs = require("../../components/Characters/Characters.js");
var _charactersJsDefault = parcelHelpers.interopDefault(_charactersJs);
...
class Comics {
            ...
            if (path.lastIndexOf(_api.IMG_NOT_AVAILABLE) === -1) {
                ...
                htmlContent += `
                    <li class="comics__item ${_comicsCssDefault.default.comics__item}" data-uri="${uri}">
                        ...
                        <img class="${_comicsCssDefault.default.comics__img}" src="${imgSrc}" />
                    </li>
                `;
            }
        });
        const htmlWrapper = `
            <ul class="${_comicsCssDefault.default.comics__container}">
                ${htmlContent}
            </ul>
        `;
    ...
    async render() {
        ...
        data ? this.renderComics(data) : _errorDefault.default.render();
    }
    eventListener() {
        document.querySelectorAll('.comics__item').forEach((element)=>{
            ...
            element.addEventListener('click', ()=>{
                console.log(uri);
                _charactersJsDefault.default.render(uri);
            });
        });
    }
}
...
},{"../../constants/api":"3QTbu","../../utils/getDataApi":"c6DGo","../../constants/root":"55nNE","./Comics.css":"lfpJ4","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../../components/Error/Error":"kyZeG","../../components/Characters/Characters.js":"eiHK9"}],"3QTbu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"1IeuP","../constants/api":"3QTbu","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1IeuP":[function(require,module,exports) {
...
},{}],"55nNE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
module.exports["comics__container"] = "_comics__container_d97485";
module.exports["comics__item"] = "_comics__item_d97485";
module.exports["comics__name"] = "_comics__name_d97485";
module.exports["comics__img"] = "_comics__img_d97485";
        ...
        const htmlWrapper = `
            <div class="${_errorCssDefault.default.error__container}">
                <span>
                    ...
                    <p class="${_errorCssDefault.default.error__alert}">Попробуйте зайти позже</p>
                </span>
            </div>
        `;
        _root.ROOT_INDEX.innerHTML = htmlWrapper;
...
},{"../../constants/root":"55nNE","./Error.css":"jpALL","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jpALL":[function(require,module,exports) {
module.exports["error__container"] = "_error__container_827c6e";
module.exports["error__alert"] = "_error__alert_827c6e";
...
var _api = require("../../constants/api");
var _root = require("../../constants/root");
var _closeSvg = require("./img/close.svg");
var _closeSvgDefault = parcelHelpers.interopDefault(_closeSvg);
class Characters {
    renderContent(data) {
        console.log(_closeSvgDefault.default);
        let htmlContent = '';
        ...
        <div class="${_charactersCssDefault.default.wrapper}">
            ...
            <button class="btn bg-contain ${_charactersCssDefault.default.characters__close}"
                onClick="modal.innerHTML = ''"
                style="background-image: url(${_closeSvgDefault.default})"
            ></button>
        </div>    
        `;
...
},{"./Characters.css":"c5HkN","../../utils/getDataApi":"c6DGo","../../constants/api":"3QTbu","../../constants/root":"55nNE","./img/close.svg":"3yYLS","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"c5HkN":[function(require,module,exports) {
module.exports["wrapper"] = "_wrapper_32d6a9";
module.exports["characters__item"] = "_characters__item_32d6a9";
module.exports["characters__img"] = "_characters__img_32d6a9";
module.exports["characters__name"] = "_characters__name_32d6a9";
module.exports["characters__container"] = "_characters__container_32d6a9";
module.exports["characters__close"] = "_characters__close_32d6a9";

},{}],"3yYLS":[function(require,module,exports) {

},{}],"grANb":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('hjDlF') + "close.cbd95e63.svg" + "?" + Date.now();
